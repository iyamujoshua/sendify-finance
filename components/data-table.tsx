...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      <HugeiconsIcon icon={GripVerticalIcon} className="size-3 text-muted-foreground" />
    ...
    <Drawer swipeDirection={isMobile ? "down" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>
            Showing digital signature status and settlement velocity profile.
          </DrawerDescription>
        </DrawerHeader>
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  Processing threshold exceeded by 5.2% this month{" "}
                  <HugeiconsIcon icon={TrendingUpIcon} className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  Showing average gas utilization and transaction processing bandwidth for custody nodes. This transaction ledger maintains a secure append-only audit trail of balances.
                </div>
              </div>
              <Separator />
            </>
          ...
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <Label htmlFor="header">Transaction ID / User</Label>
              <Input id="header" defaultValue={item.header} />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                <Label htmlFor="type">Method / Asset</Label>
                <Select
                  defaultValue={item.type}
                  items={[
                    { label: "ACH Transfer", value: "ACH Transfer" },
                    { label: "Crypto Purchase", value: "Crypto Purchase" },
                    { label: "Card Payment", value: "Card Payment" },
                    { label: "Wire Transfer", value: "Wire Transfer" },
                    { label: "SEPA Settlement", value: "SEPA Settlement" },
                    { label: "Yield Accrual", value: "Yield Accrual" },
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="Crypto Purchase">Crypto Purchase</SelectItem>
                      <SelectItem value="Card Payment">Card Payment</SelectItem>
                      <SelectItem value="Wire Transfer">Wire Transfer</SelectItem>
                      <SelectItem value="SEPA Settlement">SEPA Settlement</SelectItem>
                      <SelectItem value="Yield Accrual">Yield Accrual</SelectItem>
                      <SelectItem value="Manual Journal">Manual Journal</SelectItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                <Label htmlFor="limit">Fee ($)</Label>
                <Input id="limit" defaultValue={item.limit} />
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">Settlement Processor</Label>
              <Select
                defaultValue={item.reviewer}
                items={[
                  { label: "Plaid Core API", value: "Plaid Core API" },
                  { label: "Stripe Connect", value: "Stripe Connect" },
                  { label: "Coinbase Prime Custody", value: "Coinbase Prime Custody" },
                  { label: "Federal Reserve FedWire", value: "Federal Reserve FedWire" },
                  { label: "Adyen Payments", value: "Adyen Payments" },
                  { label: "Swift Network", value: "Swift Network" },
                  { label: "Internal Ledger Core", value: "Internal Ledger Core" },
                ]}
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="Plaid Core API">Plaid Core API</SelectItem>
                    <SelectItem value="Stripe Connect">Stripe Connect</SelectItem>
                    <SelectItem value="Coinbase Prime Custody">Coinbase Prime Custody</SelectItem>
                    <SelectItem value="Federal Reserve FedWire">Federal Reserve FedWire</SelectItem>
                    <SelectItem value="Adyen Payments">Adyen Payments</SelectItem>
                    <SelectItem value="Swift Network">Swift Network</SelectItem>
                    <SelectItem value="Internal Ledger Core">Internal Ledger Core</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
            </div>
